...
public enum ConditionEnum {
    ...
    @XmlEnumValue("AND") AND(String.valueOf("AND")), @XmlEnumValue("OR") OR(String.valueOf("OR"));
    ...
    /**
    * The logical operator combining the expressions.
    **/
    ...
    @ApiModelProperty(example = "AND", required = true, value = "The logical operator combining the expressions.")
    ...
    /**
    * The list of expressions that define the rule conditions.
    **/
    public RuleRequest expressions(List<ExpressionRequest> expressions) {

        this.expressions = expressions;
        return this;
    }
    
    @ApiModelProperty(required = true, value = "The list of expressions that define the rule conditions.")
    ...
    public RuleRequest addExpressionsItem(ExpressionRequest expressionsItem) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.condition, ruleRequest.condition) &&
            Objects.equals(this.expressions, ruleRequest.expressions);
    }
